...
def plot1():
    ...
    y_plt = []
    k,NADG,EDG,ODG,CDG,Best = get_values("./OriginalData/Entropy_Vs_K.csv")
    ...
    y_ticks = np.arange(0,6,0.5)
    title = "EffectiveCR Vs Obstracles"
    x_label = "k"
    y_label = "Entropy"
    legends = ('NADG','EDG','ODG','CDG','Best')
    filename = "Entropy_Vs_K.eps"
    
    plot_graph(x_plt, y_plt, X_plt, x_ticks, y_ticks, title, x_label, y_label, legends, [2,41], [0,6], filename, 4)
